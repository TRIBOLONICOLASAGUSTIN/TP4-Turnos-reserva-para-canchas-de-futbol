...
export default function NuevaReservaPage() {
  ...
  async function handleReservar() {
    ...
    try {
      ...
      setExito('¡Reserva confirmada! Redirigiendo...');
      ...
      <div className="reserva-form card">
        <div className="reserva-selects">
          <div className="form-group">
            ...
            <select className="form-control" value={disciplinaId}
          ...
          <div className="form-group">
            ...
            <select className="form-control" value={espacioId}
          ...
          <div className="form-group">
            <label>Fecha</label>
            <input type="date" className="form-control" value={fecha} min={hoy()}
              onChange={(e) => setFecha(e.target.value)} disabled={!espacioId} />
          </div>
        </div>
